import { ControlOutlined, LeftOutlined, RightOutlined } from "@ant-design/icons"
...
const DashboardDriverComponent: React.FC<{
  driverId: string
  setStatusFullSize: any
  statusFullSize: boolean
    ...
    <LoadScript googleMapsApiKey={appConfig.googleMapAPIKey}>
      <Row justify="space-between" style={{ margin: 10 }}>
        <Col>
          <Space>
            <Button
              onClick={() => {
                setStatusFullSize(!statusFullSize)
              }}
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={17}>
          <DriverECRChart
            driverId={driverId}
            ecrThreshold={driver.ecrThreshold}
          />
        </Col>
        <Col span={24}>
